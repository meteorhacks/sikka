...
Config.rateLimits = {
  perIp: Sikka._getConfig("SIKKA_PER_IP_MAX_RPS", "sikka.rateLimits.perIp", 50),
  perHuman: Sikka._getConfig("SIKKA_PER_HUMAN_MAX_RPS", "sikka.rateLimits.perHuman", 20),
  perSession: Sikka._getConfig("SIKKA_PER_HUMAN_MAX_RPS", "sikka.rateLimits.perSession", 20),
};
